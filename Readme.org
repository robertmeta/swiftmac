...
#+BEGIN_SRC shell
  ./download-premium-voices.sh          # Show available voices
  ./download-premium-voices.sh verify   # Verify installed voices
#+END_SRC
...
**Shell Test Scripts:**
- =test-clean-emacspeak.sh= - Test with clean Emacspeak environment
- =test-dual-mode.sh= - Test dual-process mode
- =test-multi-device.sh= - Test multi-device routing
- =test-multiple-instances.sh= - Test multiple SwiftMac instances
- =test-proper-dual.sh= - Test proper dual-mode setup
