...
3. Wait for GitHub Actions to create the release (usually ~2 minutes)
...
4. Update the Homebrew formula:
   ...
   - Update the formula in =../homebrew-swiftmac=
   - Commit and push the changes

5. Release is now available:
   - Download: =https://github.com/robertmeta/swiftmac/releases=
   - Homebrew: =brew upgrade swiftmac=
...
make update-brew  # Update Homebrew formula with current version
